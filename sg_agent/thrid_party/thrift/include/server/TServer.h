...
class TServer : public concurrency::Runnable {
 public:
  ...
  boost::shared_ptr<TProcessorFactory> getProcessorFactory() {
    boost::mutex::scoped_lock(processorFactoryMutex_);
...
protected:
  ...
  // Class variables
  boost::mutex processorFactoryMutex_;
...
public:
  void setProcessorFactory(boost::shared_ptr<TProcessorFactory> processorFactory) {
    boost::mutex::scoped_lock(processorFactoryMutex_);
    processorFactory_ = processorFactory;
  }          
